...
<body>
    ...
    <div class="body">
        <div class="body">
            ...
            <div class="side">
                ...
                <ul class="menu">
                    <li><a href="index.php?hal=catatan_perjalanan">Catatan Perjalanan</a></li>
                    <li><a href="profil.php?hal=catatan_perjalanan">Profil</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <td>
        ...
        <center>
            <h1 style="text-align: center;">BIOGAPHY</h1>
            <hr>
            <img style="text-align: center;" src="../../asset/donut" alt="300" width="300" height="300">
            <h1>Fadli Faris</h1>
            <p>bersekolah di SMKN 5 Kota Bekasi</p>
        </center>
